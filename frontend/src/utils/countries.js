// Country list with E.164 dialing codes (broad coverage)
export const countries = [
  ...
  { name: 'Virgin Islands (British)', dialCode: '1' },
  { name: 'Virgin Islands (U.S.)', dialCode: '1' },
...
export const getDialCodeByCountry = (name) => {
  const found = countries.find((c) => c.name === name);
  return found ? found.dialCode : '';
};

// Keep phone as digits only to satisfy length-based validation on frontend/backend
export const applyDialCodeToDigits = (currentPhone, dialCode) => {
